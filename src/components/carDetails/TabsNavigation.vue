<template>
    <div>
        ...
        <div class="tabs flex border-b border-gray-300 my-6">
            <button class="tab-button flex-1 py-2 px-4 text-center cursor-pointer border-b-2" :class="{
        ...
        <div v-if="car" class="tab-content mt-4">
            <div v-if="activeTab === 'features'">
                <ul>
                    <li v-for="(value, feature) in car.features" :key="feature" class="flex items-center gap-4 mb-2">
