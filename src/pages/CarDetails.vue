<template>
    <BgContainer title="Car Detail" bgImage="bg_3.jpg" :links="[
        { text: 'Home', to: '/' },
        { text: 'Cars', to: '/cars' },
    ]" />
        ...
        <div class="w-full md:w-4/5">
            ...
            <div class="my-20 flex justify-center">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <CarCard v-for="(car, index) in cars.slice(0, 3)" :key="index" :id="car.id" :name="car.name"
                        :brand="car.brand" :price="car.price" :image="car.image" />
                </div>
            </div>
        </div>
    </div>
